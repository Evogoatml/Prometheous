"""
Prometheous symbolic knowledge system.

Coordinates pattern interpretation, skill discovery, symbolic decisions, and
knowledge transfer across the Prometheous cognitive stack (brain + learning + NeuroGraph).
"""
...
# Use brain versions where they live (real integration)
try:
    from brain.pattern_interpreter import PatternInterpreter
    from brain.decision_maker import SymbolicDecisionMaker
except Exception:
    from .pattern_interpreter import PatternInterpreter  # if local copy exists
...
class KnowledgeSystem:
    """
    Prometheous symbolic knowledge coordinator.

    - Pattern interpretation from neural/trajectory insights
    - Skill discovery and management
    - Symbolic decision-making (pairs with rule-based core.decision)
    - Knowledge transfer between environments/tasks
    """
